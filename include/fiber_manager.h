...
extern void fiber_manager_wait_in_mpmc_queue(fiber_manager_t* manager,
                                             mpmc_fifo_t* fifo);

extern int fiber_manager_wake_from_mpmc_queue(fiber_manager_t* manager,
                                              mpmc_fifo_t* fifo, int count);

extern void fiber_manager_wait_in_mpsc_queue(fiber_manager_t* manager,
                                             mpsc_fifo_t* fifo);

extern void fiber_manager_wait_in_mpsc_queue_and_unlock(
    fiber_manager_t* manager, mpsc_fifo_t* fifo, fiber_mutex_t* mutex);

extern int fiber_manager_wake_from_mpsc_queue(fiber_manager_t* manager,
                                              mpsc_fifo_t* fifo, int count);

extern void fiber_manager_set_and_wait(fiber_manager_t* manager,
...
extern hazard_pointer_thread_record_t* fiber_manager_get_hazard_record(
...
extern void fiber_manager_stats(fiber_manager_t* manager,
                                fiber_manager_stats_t* out);
